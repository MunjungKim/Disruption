The original node2vec code that implements the restriction of the context window can be found in [https://github.com/skojaku/node2vec](https://github.com/skojaku/node2vec)
